...
! function () {
  "use strict";
  var e, t, n, r, o, i, a, d = function (e) {
      var t = e;
      return {
        get: function () {
          return t
    ...
    ee = function (i, e) {
      ...
      return Z(i, e.commonAncestorContainer, r, a, {
        ...
        cef: function (e) {
          var t, n, r, o = M(U(W.fromDom(e), "*[contenteditable=true]"), function (e) {
            var t = e.dom;
            return Z(i, t, t)
          });
          return t = o, n = function (e, t) {
    ...
    me = function (e, t, n, r, o, i) {
      var a, u, c, l = (a = o, u = "(" + n.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&").replace(/\s/g, "[^\\S\\r\\n\\uFEFF]") + ")", a ? "(?:^|\\s|" + y() + ")" + u + "(?=$|\\s|" + y() + ")" : u),
        s = {
        ...
        o = {
          ...
          onAction: function (e, t) {
            ...
            switch (t.name) {
              ...
              case "wholewords":
              case "inselection":
                n = e.getData(), r = a.get(), a.set(h(h({}, r), {
