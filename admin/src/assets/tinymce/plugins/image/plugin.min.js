...
! function () {
  ...
  var e, t, n, r, o, i = tinymce.util.Tools.resolve("tinymce.PluginManager"),
    ...
    ve = function (t, e) {
      ...
      var r, i = t.dom.select('*[data-mce-id="__mcenew"]')[0];
      t.dom.setAttrib(i, "data-mce-id", null), oe(i) ? (r = be(t, i), t.selection.select(r)) : t.selection.select(i)
    },
    ye = function (t, e) {
      var n, r, i, a, o, l, s = he(t);
      fe(function (e) {
        return pe(t, e)
      }, e, s), n = s, t.dom.setAttrib(n, "src", n.getAttribute("src")), oe(s.parentNode) ? (r = s.parentNode, be(t, r), t.selection.select(s.parentNode)) : (t.selection.select(s), i = t, a = e, l = function () {
    ...
    Ae = (o = function (e, t) {
      ...
      for (var n = {}, r = 0; r < e.length; r++) {
        var i = e[r];
        for (var a in i) De.call(i, a) && (n[a] = o(n[a], i[a]))
      }
      return n
    }),
    ...
    Ue = function (e, a) {
      ...
      return Se.each(e, function (e) {
        var t, n, r, i = w((t = e).text) ? t.text : w(t.title) ? t.title : "";
      ...
      return function (e) {
        ...
        return {
          ...
          body: (r = e).hasAdvTab || r.hasUploadUrl || r.hasUploadHandler ? {
            type: "tabpanel",
            tabs: N([
              [Ee(r)], r.hasAdvTab ? [Pe(r)] : [], r.hasUploadTab && (r.hasUploadUrl || r.hasUploadHandler) ? [je(r)] : []
            ])
          } : {
            type: "panel",
            items: Me(r)
      ...
      var t, n, r, i, a, o, l, s, u = {
        ...
        uploadImage: (t = n = r = i = a = o = l = e, function (e) {
          return we(t).upload([e], !1).then(function (e) {
            return 0 === e.length ? j.reject("Failed to upload image") : !1 === e[0].status ? j.reject(e[0].error.message) : e[0]
          })
        })
      };
      return {
      ...
      u.addCommand("mceImage", $e(u).open), u.addCommand("mceUpdateImage", function (e, s) {
        u.undoManager.transact(function () {
          return e = s, void((l = he(t = u)) ? (n = ce(function (e) {
            return pe(t, e)
          }, l), (r = c(c({}, n), e)).src ? ye(t, r) : (i = t, (a = l) && (o = i.dom.is(a.parentNode, "figure.image") ? a.parentNode : a, i.dom.remove(o), i.focus(), i.nodeChanged(), i.dom.isEmpty(i.getBody()) && (i.setContent(""), i.selection.setCursorLocation())))) : e.src && ve(t, c(c({}, se()), e)));
          var t, e, n, r, i, a, o, l
        })
      })
    },
