...
! function () {
  "use strict";
  var n, t, e, r, o = tinymce.util.Tools.resolve("tinymce.PluginManager"),
    ...
    M = function (t, i) {
      ...
      return L.each(t, function (t) {
        var n, e, r, o = l((n = t).text) ? n.text : l(n.title) ? n.title : "";
    ...
    it = function (l) {
      l.undoManager.transact(function () {
        var t, n, e, r, o, i, u, a = l.selection.getNode();
    ...
    gt = function (t, i) {
      var u = {
        ...
        r = function (t) {
          var n, e, r = (n = t.url, D(u.text.length <= 0, N.from(n.meta.text).getOr(n.value))),
        ...
        o = function (t, n) {
          var e, r, o = (e = i, ("link" === (r = n.name) ? e.link : "anchor" === r ? e.anchor : N.none()).getOr([]));
    ...
    At = function (f, s) {
      return bt(f).then(function (t) {
        var n, e, r, o, i, u, a, l, c = (e = s, r = (n = f).dom, o = tt(n) ? N.some(Y(n.selection, e)) : N.none(), i = e ? N.some(r.getAttrib(e, "href")) : N.none(), u = e ? N.from(r.getAttrib(e, "target")) : N.none(), a = Nt(r, e, "rel"), l = Nt(r, e, "class"), {
          url: i,
          text: o,
          title: Nt(r, e, "title"),
          target: u,
      ...
      (n = Q(t = h), At(t, n)).then(function (t) {
        ...
        return e = function (t) {
          ...
          var n = function (n) {
            ...
            o = {
              href: e.url.value,
              attach: e.url.meta !== undefined && e.url.meta.attach ? e.url.meta.attach : y
            };
    ...
    Tt = function (t) {
      ...
      var e, r, o = document.createEvent("MouseEvents");
