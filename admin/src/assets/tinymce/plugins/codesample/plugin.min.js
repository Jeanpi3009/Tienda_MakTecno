...
! function () {
  "use strict";
  var e, n, t, a = tinymce.util.Tools.resolve("tinymce.PluginManager"),
    s = function (e) {
      return function () {
        return e
      }
  ...
  ! function (n, t, a, d) {
    ...
    window.Prism = {
      ...
      function (e) {
        "object" == typeof t && void 0 !== a ? a.exports = e() : "function" == typeof n && n.amd ? n([], e) : ("undefined" != typeof window ? window : void 0 !== y ? y : "undefined" != typeof self ? self : this).EphoxContactWrapper = e()
      }(function () {
        return function c(s, i, o) {
          ...
          for (var u = "function" == typeof d && d, e = 0; e < o.length; e++) l(o[e]);
          return l
        }({
          1: [function (e, n, t) {
                ...
                var e = function (u) {
                  var c = /\blang(?:uage)?-([\w-]+)\b/i,
                    ...
                    C = {
                      ...
                      util: {
                        encode: function r(e) {
                          return e instanceof O ? new O(e.type, r(e.content), e.alias) : Array.isArray(e) ? e.map(r) : e.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/\u00a0/g, " ")
                        },
                        type: function (e) {
                        ...
                        clone: function i(e, t) {
                          var a, n;
                          switch (t = t || {}, C.util.type(e)) {
                            case "Object":
                              if (n = C.util.objId(e), t[n]) return t[n];
                              for (var r in a = {}, t[n] = a, e) e.hasOwnProperty(r) && (a[r] = i(e[r], t));
                              return a;
                            case "Array":
                      ...
                      languages: {
                        ...
                        insertBefore: function (t, e, n, a) {
                          var r = (a = a || C.languages)[t],
                            s = {};
                          for (var i in r)
                            if (r.hasOwnProperty(i)) {
                              if (i == e)
                                for (var o in n) n.hasOwnProperty(o) && (s[o] = n[o]);
                              n.hasOwnProperty(i) || (s[i] = r[i])
                            } var l = a[t];
                          return a[t] = s, C.languages.DFS(C.languages, function (e, n) {
                            n === l && e != t && (this[e] = s)
                          }), s
                        },
                        DFS: function l(e, n, t, a) {
                          a = a || {};
                          var r, s, i = C.util.objId;
                          for (var o in e) {
                            e.hasOwnProperty(o) && (n.call(e, o, e[o], t || o), r = e[o], "Object" !== (s = C.util.type(r)) || a[i(r)] ? "Array" !== s || a[i(r)] || (a[i(r)] = !0, l(r, n, o, a)) : (a[i(r)] = !0, l(r, n, null, a)))
                          }
                        }
                      },
                      plugins: {},
                      ...
                      highlightAllUnder: function (e, n, t) {
                        ...
                        for (var r, s = 0; r = a.elements[s++];) C.highlightElement(r, !0 === n, a.callback)
                      },
                      highlightElement: function (e, n, t) {
                        ...
                        function l(e) {
                          o.highlightedCode = e, C.hooks.run("before-insert", o), o.element.innerHTML = o.highlightedCode, C.hooks.run("after-highlight", o), C.hooks.run("complete", o), t && t.call(o.element)
                        }
                        if (C.hooks.run("before-sanity-check", o), !o.code) return C.hooks.run("complete", o), void(t && t.call(o.element));
                        C.hooks.run("before-highlight", o), o.grammar ? n && u.Worker ? ((i = new Worker(C.filename)).onmessage = function (e) {
                          l(e.data)
                        }, i.postMessage(JSON.stringify({
                          language: o.language,
                          code: o.code,
                          immediateClose: !0
                        }))) : l(C.highlight(o.code, o.grammar, o.language)) : l(C.util.encode(o.code))
                      },
                      highlight: function (e, n, t) {
                        ...
                        return C.hooks.run("before-tokenize", a), a.tokens = C.tokenize(a.code, a.grammar), C.hooks.run("after-tokenize", a), O.stringify(C.util.encode(a.tokens), a.language)
                      },
                            ...
                            for (var i in t)
                              if (t.hasOwnProperty(i) && t[i]) {
                                ...
                                for (var l = 0; l < o.length; ++l) {
                                  ...
                                  for (var f = c.pattern || c, b = a.next, h = r; b !== n.tail && !(s && h >= s.reach); h += b.value.length, b = b.next) {
                                    var y = b.value;
                                    if (n.length > e.length) return;
                                    if (!(y instanceof O)) {
                                      var w, v = 1;
                                      if (g) {
                                        if (!(w = N(f, h, e, p))) break;
                                        var k = w.index,
                                          _ = w.index + w[0].length,
                                          x = h;
                                        for (x += b.value.length; x <= k;) b = b.next, x += b.value.length;
                                        if (x -= b.value.length, h = x, b.value instanceof O) continue;
                                        for (var P = b; P !== n.tail && (x < _ || "string" == typeof P.value); P = P.next) v++, x += P.value.length;
                                        v--, y = e.slice(h, x), w.index -= h
                                      } else if (!(w = N(f, 0, y, p))) continue;
                                      var k = w.index,
                                        F = w[0],
                                        A = y.slice(0, k),
                                        S = y.slice(k + F.length),
                                        $ = h + y.length;
                                      s && $ > s.reach && (s.reach = $);
                                      var j = b.prev;
                                      A && (j = T(n, j, A), h += A.length), B(n, j, v);
                                      var z = new O(i, d ? C.tokenize(F, d) : F, m, F);
                                      b = T(n, j, z), S && T(n, b, S), 1 < v && E(e, n, t, b.prev, h, {
                                        cause: i + "," + l,
                                        reach: $
                                      })
                                    }
                  ...
                  if (u.Prism = C, O.stringify = function o(e, n) {
                      ...
                      var a = {
                        ...
                        r = e.alias;
                      r && (Array.isArray(r) ? Array.prototype.push.apply(a.classes, r) : a.classes.push(r)), C.hooks.run("wrap", a);
                      var s = "";
                      for (var i in a.attributes) s += " " + i + '="' + (a.attributes[i] || "").replace(/"/g, "&quot;") + '"';
                    ...
                    var n = JSON.parse(e.data),
                      ...
                      a = n.code,
                      r = n.immediateClose;
                    u.postMessage(C.highlight(a, C.languages[t], t)), r && u.close()
                  }, !1)), C;
                  var e, t = C.util.currentScript();

                  function a() {
                    C.manual || C.highlightAll()
                  }
                  return t && (C.filename = t.src, t.hasAttribute("data-manual") && (C.manual = !0)), C.manual || ("loading" === (e = document.readyState) || "interactive" === e && t && t.defer ? document.addEventListener("DOMContentLoaded", a) : window.requestAnimationFrame ? window.requestAnimationFrame(a) : window.setTimeout(a, 16)), C
          ...
          4: [function (e, n, t) {
            var a, r;
            a = Prism, r = /\b(?:alignas|alignof|asm|auto|bool|break|case|catch|char|char8_t|char16_t|char32_t|class|compl|concept|const|consteval|constexpr|constinit|const_cast|continue|co_await|co_return|co_yield|decltype|default|delete|do|double|dynamic_cast|else|enum|explicit|export|extern|float|for|friend|goto|if|inline|int|int8_t|int16_t|int32_t|int64_t|uint8_t|uint16_t|uint32_t|uint64_t|long|mutable|namespace|new|noexcept|nullptr|operator|private|protected|public|register|reinterpret_cast|requires|return|short|signed|sizeof|static|static_assert|static_cast|struct|switch|template|this|thread_local|throw|try|typedef|typeid|typename|union|unsigned|using|virtual|void|volatile|wchar_t|while)\b/, a.languages.cpp = a.languages.extend("c", {
              "class-name": [{
          ...
          5: [function (e, n, t) {
            ! function (t) {
              ...
              var n = "bool byte char decimal double dynamic float int long object sbyte short string uint ulong ushort var void",
                ...
                i = "add alias and ascending async await by descending from get global group into join let nameof not notnull on or orderby partial remove select set unmanaged value when where",
              ...
              var u = l(s),
                ...
                b = a(/<<0>>(?:\s*<<1>>)?/.source, [f, g]),
                h = a(/(?!<<0>>)<<1>>(?:\s*\.\s*<<1>>)*/.source, [d, b]),
                y = /\[\s*(?:,\s*)*\]/.source,
                w = a(/<<0>>(?:\s*(?:\?\s*)?<<1>>)*(?:\s*\?)?/.source, [h, y]),
                v = a(/[^,()<>[\];=+\-*/%&|^]|<<0>>|<<1>>|<<2>>/.source, [g, m, y]),
                k = a(/\(<<0>>+(?:,<<0>>+)+\)/.source, [v]),
                _ = a(/(?:<<0>>|<<1>>)(?:\s*(?:\?\s*)?<<2>>)*(?:\s*\?)?/.source, [k, h, y]),
                x = {
                  keyword: c,
                  punctuation: /[<>()?,.:[\]]/
                },
              ...
              t.languages.csharp = t.languages.extend("clike", {
                ...
                "class-name": [{
                  ...
                  pattern: r(/(\busing\s+<<0>>\s*=\s*)<<1>>(?=\s*;)/.source, [f, _]),
                  lookbehind: !0,
                  inside: x
                }, {
                  ...
                  pattern: r(/\b<<0>>(?=\s+(?!<<1>>)<<2>>(?:\s*[=,;:{)\]]|\s+(?:in|when)\b))/.source, [_, p, f]),
                  inside: x
                }],
                keyword: c,
                ...
                namespace: {
                  pattern: r(/(\b(?:namespace|using)\s+)<<0>>(?:\s*\.\s*<<0>>)*(?=\s*[;{])/.source, [f]),
                  lookbehind: !0,
                  inside: {
                    punctuation: /\./
                  }
                ...
                "type-expression": {
                  pattern: r(/(\b(?:default|typeof|sizeof)\s*\(\s*(?!\s))(?:[^()\s]|\s(?!\s)|<<0>>)*(?=\s*\))/.source, [m]),
                  lookbehind: !0,
                  alias: "class-name",
                  inside: x
                },
                ...
                "type-list": {
                  pattern: r(/\b((?:<<0>>\s+<<1>>|where\s+<<2>>)\s*:\s*)(?:<<3>>|<<4>>)(?:\s*,\s*(?:<<3>>|<<4>>))*(?=\s*(?:where|[{;]|=>|$))/.source, [u, b, f, _, c.source]),
                  lookbehind: !0,
                  inside: {
                    keyword: c,
                    "class-name": {
              ...
              var C = /:[^}\r\n]+/.source,
                O = e(a(/[^"'/()]|<<0>>|\(<<self>>*\)/.source, [$]), 2),
                N = a(/\{(?!\{)(?:(?![}:])<<0>>)*<<1>>?\}/.source, [O, C]),
                T = e(a(/[^"'/()]|\/(?!\*)|\/\*(?:[^*]|\*(?!\/))*\*\/|<<0>>|\(<<self>>*\)/.source, [S]), 2),
                B = a(/\{(?!\{)(?:(?![}:])<<0>>)*<<1>>?\}/.source, [T, C]);
          ...
          6: [function (e, n, t) {
            ! function (e) {
              ...
              e.languages.css = {
                ...
                selector: RegExp("[^{}\\s](?:[^{};\"'\\s]|\\s+(?![\\s{])|" + n.source + ")*(?=\\s*\\{)"),
                string: {
                  pattern: n,
                  greedy: !0
                },
          ...
          9: [function (e, n, t) {
            ...
            y = Prism, Object.defineProperties(y.languages["markup-templating"] = {}, {
              buildPlaceholders: {
                value: function (a, r, e, s) {
                  ...
                  a.language === r && (i = a.tokenStack = [], a.code = a.code.replace(e, function (e) {
                    ...
                    for (var n, t = i.length; - 1 !== a.code.indexOf(n = h(r, t));) ++t;
                    return i[t] = e, n
              ...
              tokenizePlaceholders: {
                value: function (p, g) {
                  var m, f;
                  p.language === g && p.tokenStack && (p.grammar = y.languages[g], m = 0, f = Object.keys(p.tokenStack), function b(e) {
                    for (var n = 0; n < e.length && !(m >= f.length); n++) {
                      var t, a, r, s, i, o, l, u, c, d = e[n];
                      "string" == typeof d || d.content && "string" == typeof d.content ? (t = f[m], a = p.tokenStack[t], r = "string" == typeof d ? d : d.content, s = h(g, t), -1 < (i = r.indexOf(s)) && (++m, o = r.substring(0, i), l = new y.Token(g, y.tokenize(a, p.grammar), "language-" + g, a), u = r.substring(i + s.length), c = [], o && c.push.apply(c, b([o])), c.push(l), u && c.push.apply(c, b([u])), "string" == typeof d ? e.splice.apply(e, [n, 1].concat(c)) : d.content = c)) : d.content && b(d.content)
                    }
                    return e
                  }(p.tokens))
                }
          ...
          14: [function (e, n, t) {
            ...
            e("prismjs/components/prism-clike"), e("prismjs/components/prism-markup-templating"), e("prismjs/components/prism-c"), e("prismjs/components/prism-cpp"), e("prismjs/components/prism-csharp"), e("prismjs/components/prism-css"), e("prismjs/components/prism-java"), e("prismjs/components/prism-javascript"), e("prismjs/components/prism-markup"), e("prismjs/components/prism-php"), e("prismjs/components/prism-python"), e("prismjs/components/prism-ruby"), n.exports = {
              boltExport: a
            }
          }, {
    ...
    var r = window.Prism;
    window.Prism = e
  }(undefined, b, h, undefined);
  var w = h.exports.boltExport,
    v = function (e) {
      return f.Prism && e.getParam("codesample_global_prismjs", !1, "boolean") ? f.Prism : w
    },
    k = function (e) {
    ...
    _ = function (s) {
      var t, e = s.getParam("codesample_languages") || [{
          text: "HTML/XML",
          value: "markup"
        }, {
          text: "JavaScript",
      ...
      s.windowManager.open({
        ...
        onSubmit: function (e) {
          var n, t, a, r = e.getData();
          n = s, t = r.language, a = r.code, n.undoManager.transact(function () {
            var e = k(n);
            return a = p.DOM.encode(a), e.fold(function () {
              n.insertContent('<pre id="__new" class="language-' + t + '">' + a + "</pre>"), n.selection.select(n.$("#__new").removeAttr("id")[0])
            }, function (e) {
              n.dom.setAttrib(e, "class", "language-" + t), e.innerHTML = a, v(n).highlightElement(e), n.selection.select(e)
            })
          }), e.close()
        }
      })
    ...
    x = function (a) {
      a.ui.registry.addToggleButton("codesample", {
        icon: "code-sample",
        ...
        onSetup: function (t) {
          var e = function () {
            var e, n;
            t.setActive((n = (e = a).selection.getStart(), e.dom.is(n, 'pre[class*="language-"]')))
          };
          return a.on("NodeChange", e),
            function () {
              return a.off("NodeChange", e)
            }
        }
      }), a.ui.registry.addMenuItem("codesample", {
        text: "Code sample...",
        icon: "code-sample",
        onAction: function () {
          return _(a)
  ...
  a.add("codesample", function (n) {
    var t, r, a;
    r = (t = n).$, t.on("PreProcess", function (e) {
      r("pre[contenteditable=false]", e.node).filter(m(g)).each(function (e, n) {
        var t = r(n),
          a = n.textContent;
      ...
      var e = r("pre").filter(m(g)).filter(function (e, n) {
      ...
      e.length && t.undoManager.transact(function () {
        e.each(function (e, n) {
          ...
          }), n.contentEditable = "false", n.innerHTML = t.dom.encode(n.textContent), v(t).highlightElement(n), n.className = r.trim(n.className)
        })
      })
    }), x(n), (a = n).addCommand("codesample", function () {
      var e = a.selection.getNode();
      a.selection.isCollapsed() || g(e) ? _(a) : a.formatter.toggle("code")
