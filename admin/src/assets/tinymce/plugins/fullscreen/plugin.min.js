...
! function () {
  ...
  var t, r, o, l = u(!1),
    ...
    nn = function (n) {
      var t, r, e = M.fromDom(function (n) {
          if (I() && w(n.target)) {
    ...
    an = function (n) {
      var e, t, r, o, u = n === undefined ? window : n,
        i = u.document,
    ...
    xn = mn.os.isAndroid(),
    Dn = function (n) {
      var e, t, r, o, u = (t = "background-color", r = (e = n).dom, "" !== (o = window.getComputedStyle(r).getPropertyValue(t)) || Y(e) ? o : $(r, t));
      return u !== undefined && "" !== u ? "background-color:" + u + "!important" : "background-color:rgb(255,255,255)!important;"
    },
    kn = function (o, n, e) {
      var t, r, u = function (r) {
          return function (n) {
            var e = J(n, "style"),
    ...
    An = function (e, r) {
      var n, t, o, u, i, c, l, f = document.body,
    ...
    Nn = function (t, r) {
      return function (e) {
        ...
        return t.on("FullscreenStateChanged", n),
          function () {
