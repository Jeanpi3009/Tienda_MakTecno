...
! function () {
  ...
  var n, r, e, o = function () {},
    ...
    m = function (e) {
      return function (t) {
        return r = typeof (n = t), (null === n ? "null" : "object" == r && (Array.prototype.isPrototypeOf(n) || n.constructor && "Array" === n.constructor.name) ? "array" : "object" == r && (String.prototype.isPrototypeOf(n) || n.constructor && "String" === n.constructor.name) ? "string" : r) === e;
        var n, r
      }
    },
    g = m("string"),
    ...
    S = (function (i) {
      ...
      w(i, function (t, e) {
        ...
        var o = n[0],
          a = t[o];
        if (r[o] !== undefined) throw new Error("duplicate key detected:" + o);
    ...
    _ = function (o) {
      var a = function (t) {
        ...
        t = function (t, n, r) {
          if (o.format === undefined) return o.cmd !== undefined ? g(o.cmd) ? D.value(r(o.cmd, o.value)) : a(t + " pattern has non-string `cmd` parameter") : a(t + " pattern is missing both `format` and `cmd` parameters");
          var e = void 0;
          if (h(o.format)) {
            if (!R(o.format, g)) return a(t + " pattern has non-string items in the `format` array");
            e = o.format
          } else {
            if (!g(o.format)) return a(t + " pattern has non-string `format` parameter");
            e = [o.format]
          }
          return D.value(n(e))
        };
      ...
      if (o.end === undefined) return o.replacement !== undefined ? g(o.replacement) ? 0 === o.start.length ? a("Replacement pattern has empty `start` parameter") : D.value({
        type: "inline-command",
        start: "",
        end: o.start,
    ...
    q = function (t) {
      return {
        inlinePatterns: C(t, I),
        blockPatterns: j(C(t, A))
      }
    },
    L = function (e) {
      return {
        ...
        getPatterns: function () {
          return function () {
            ...
            for (var e = Array(t), o = 0, n = 0; n < r; n++)
              for (var a = arguments[n], i = 0, u = a.length; i < u; i++, o++) e[o] = a[i];
            return e
    ...
    Z = function (t, n, r) {
      var e;
      n && t.isEmpty(n) && !r(n) && (e = n.parentNode, t.remove(n), Z(t, e, r))
    },
    $ = function (t, n, r, e) {
      void 0 === e && (e = !0);
      var o = n.startContainer.parentNode,
        a = n.endContainer.parentNode;
      n.deleteContents(), e && !r(n.startContainer) && (Y(n.startContainer) && 0 === n.startContainer.data.length && t.remove(n.startContainer), Y(n.endContainer) && 0 === n.endContainer.data.length && t.remove(n.endContainer), Z(t, o, r), o !== a && Z(t, a, r))
    },
    tt = function (t, n) {
      var r = n.get(t);
      return h(r) && T(r).exists(function (t) {
    ...
    ft = function (t, n, r, e, o) {
      var a, i = z(t, (a = t, function (t) {
        return a.isBlock(t) || k(["BR", "IMG", "HR", "INPUT"], t.nodeName) || "false" === a.getContentEditable(t)
      }));
    ...
    lt = function (t, n) {
      var r, e, o, a = n.slice(),
        i = a.pop();
      return (r = a, e = function (t, n) {
        return t.bind(function (t) {
          return y.from(t.childNodes[n])
        })
      }, o = y.some(t), w(r, function (t) {
        o = e(o, t)
      }), o).bind(function (t) {
        return Y(t) && (i < 0 || i > t.data.length) ? y.none() : y.some({
          node: t,
          offset: i
        })
      })
    ...
    mt = function (e, o, n) {
      (function (t, n, r) {
        ...
        ut(r, n.start.length, o).each(function (t) {
          var n = e.createRng();
          n.setStart(r, 0), n.setEnd(t.container, t.offset), $(e, n, function (t) {
            return t === o
          })
        })
      })
    ...
    gt = function (e, a) {
      ...
      return rt(e, t).filter(function (t) {
        var n = G(e),
          r = "" === n && i.is(t, "body") || i.is(t, n);
        return null !== t && r
      }).bind(function (n) {
        var t, r, e, o = n.textContent;
        return (t = a, e = (r = o).replace("\xa0", " "), x(t, function (t) {
          return 0 === r.indexOf(t.start) || 0 === e.indexOf(t.start)
        })).map(function (t) {
          return K.trim(o).length === t.start.length ? [] : [{
            pattern: t,
            range: st(i.getRoot(), n, 0, n, 0)
          }]
        })
      }).getOr([])
    },
    pt = function (i, t) {
      var n;
      0 !== t.length && (n = i.selection.getBookmark(), w(t, function (t) {
        return r = t, e = (n = i).dom, o = r.pattern, a = dt(e.getRoot(), r.range).getOrDie("Unable to resolve path range"), rt(n, a).each(function (t) {
          "block-format" === o.type ? tt(o.format, n.formatter) && n.undoManager.transact(function () {
    ...
    Ot = function (e, o, a, t) {
      var i, u = o.start;
      return ft(e, t.container, t.offset, (i = u, function (t, n) {
        ...
        if (r.offset >= u.length) {
          var t = e.createRng();
          return t.setStart(r.container, r.offset - u.length), t.setEnd(r.container, r.offset), y.some(t)
        }
        var n = r.offset - u.length;
        return it(r.container, n, a).map(function (t) {
          var n = e.createRng();
    ...
    wt = function (a, i, u) {
      ...
      return it(l, d - u.pattern.end.length, i).bind(function (t) {
        ...
        return function (t, r, n, e, o, a) {
          if (void 0 === a && (a = !1), 0 !== r.start.length || a) return at(n, e, o).bind(function (n) {
            return Ot(t, r, o, n).bind(function (t) {
              if (a) {
                if (t.endContainer === n.container && t.endOffset === n.offset) return y.none();
                if (0 === n.offset && t.endContainer.textContent.length === t.endOffset) return y.none()
              }
              return y.some(t)
            })
          });
          ...
          var n, r = st(c, (n = t).startContainer, n.startOffset, n.endContainer, n.endOffset);
          return {
            matches: o.matches.concat([{
              pattern: s,
              startRng: r,
              endRng: e
            }]),
    ...
    Ct = function (d, m, g, p, h) {
      ...
      return at(g, p, v.getRoot()).bind(function (t) {
        ...
        for (var r, e, o, a, i, u = n.toString(), f = 0; f < m.length; f++) {
          var c = m[f];
          if (r = u, e = c.end, i = a = o = void 0, a = e, i = (o = r).length - e.length, "" === a || o.length >= a.length && o.substr(i, i + a.length) === a) {
            var s = m.slice();
            s.splice(f, 1);
            var l = wt(d, h, {
              pattern: c,
    ...
    Et = function (n, t, r) {
      n.selection.setRng(r), "inline-format" === t.type ? w(t.format, function (t) {
        n.formatter.apply(t)
      }) : n.execCommand(t.cmd, !1, t.value)
    },
    xt = function (o, t) {
      var n, r, a = (n = "mce_textpattern", r = (new Date).getTime(), n + "_" + Math.floor(1e9 * Math.random()) + ++ht + String(r)),
        i = E(t, function (t, n) {
          var r = bt(o, a + "_end" + t.length, n.endRng);
          return t.concat([u(u({}, n), {
            endMarker: r
          })])
        }, []);
      return E(i, function (t, n) {
        var r = i.length - t.length - 1,
          e = nt(n.pattern) ? n.endMarker : bt(o, a + "_start" + r, n.startRng);
        return t.concat([u(u({}, n), {
          startMarker: e
        })])
      }, [])
    ...
    Rt = function (r, e, o) {
      ...
      return !1 === a.collapsed ? [] : rt(r, a).bind(function (t) {
    ...
    Tt = function (f, t) {
      var c, n, r;
      0 !== t.length && (c = f.dom, n = f.selection.getBookmark(), r = xt(c, t), w(r, function (t) {
        var n, r, e, o, a, i = c.getParent(t.startMarker.start, c.isBlock),
          u = function (t) {
            return t === i
          };
        nt(t.pattern) ? (n = f, r = t.pattern, e = t.endMarker, o = u, a = yt(n.dom, e), $(n.dom, a, o), Et(n, r, a)) : function (t, n, r, e, o) {
          var a = t.dom,
            i = yt(a, e),
            u = yt(a, r);
          $(a, u, o), $(a, i, o);
          var f = {
            ...
            c = yt(a, f);
          Et(t, n, c)
        }(f, t.pattern, t.startMarker, t.endMarker, u), kt(c, t.endMarker, u), kt(c, t.startMarker, u)
    ...
    St = function (n, r) {
      ...
      n.on("keydown", function (t) {
        13 !== t.keyCode || J.modifierPressed(t) || ! function (r, t) {
          if (!r.selection.isCollapsed()) return !1;
          var e = Rt(r, t.inlinePatterns, !1),
            o = gt(r, t.blockPatterns);
          return (0 < o.length || 0 < e.length) && (r.undoManager.add(), r.undoManager.extra(function () {
            ...
            r.execCommand("mceInsertNewLine"), n.each(function (t) {
              var n = t.container;
              "\ufeff" === n.data.charAt(t.offset - 1) && (n.deleteData(t.offset - 1, 1), Z(r.dom, n.parentNode, function (t) {
  ...
  t.add("textpattern", function (t) {
    var n, r, e = (n = function (t) {
      var n = t.getParam("textpattern_patterns", F, "array");
      if (!h(n)) return W("The setting textpattern_patterns should be an array"), {
        inlinePatterns: [],
        blockPatterns: []
      };
      var r = S(O(n, _));
      return w(r.errors, function (t) {
