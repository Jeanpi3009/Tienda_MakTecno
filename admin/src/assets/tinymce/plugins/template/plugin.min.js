...
! function () {
  ...
  var n, r, a, c = o(!1),
    ...
    y = function (n, e, t) {
      ...
      c && 0 < c.length && (r = a.create("div", null)).appendChild(c[0].cloneNode(!0)), _.each(a.select("*", r), function (e) {
        var t;
        v(e, n.getParam("template_cdate_classes", "cdate").replace(/\s+/g, "|")) && (e.innerHTML = p(n, (t = n).getParam("template_cdate_format", t.translate("%Y-%m-%d")))), v(e, i(n).replace(/\s+/g, "|")) && (e.innerHTML = p(n, f(n))), v(e, n.getParam("template_selected_content_classes", "selcontent").replace(/\s+/g, "|")) && (e.innerHTML = o)
      }), g(n, r), n.execCommand("mceInsertContent", !1, r.innerHTML), n.addVisual()
    },
    h = function (e) {
      e.addCommand("mceInsertTemplate", function (r) {
    ...
    I = function (M, t) {
      ...
      (function () {
        if (t && 0 !== t.length) return O.from(_.map(t, function (e, t) {
          var n = function (e) {
        ...
        var b = e(o),
          T = function (e, t) {
            return {
              ...
              onChange: (r = n = o, a = c, function (n, e) {
                var t;
                "template" === e.name && (t = n.getData().template, u(r, t).each(function (t) {
                  n.block("Loading..."), l(t).then(function (e) {
                    a(n, t, e)
                  })["catch"](function () {
          ...
          c = function (e, t, n) {
            var r, a, o, c, u, i, l, s, f, m, p, d, g, v = (r = M, -1 === (a = n).indexOf("<html>") && (o = "", c = r.getParam("content_style", "", "string"), u = r.getParam("content_css_cors", !1, "boolean") ? ' crossorigin="anonymous"' : "", _.each(r.contentCSS, function (e) {
              ...
              y = [{
                ...
                type: "htmlpanel",
                html: '<p aria-live="polite">' + N(t.value.description) + "</p>"
              }, {
                label: "Preview",
                type: "iframe",
                name: "preview",
          ...
          t = M.windowManager.open(T([], {
            template: "",
            preview: ""
          }));
        t.block("Loading..."), l(o[0]).then(function (e) {
          c(t, o[0], e)
        })["catch"](function () {
  ...
  e.add("template", function (e) {
    ...
    (t = e).ui.registry.addButton("template", {
      ...
      onAction: d(t, k(t))
    }), h(e), (r = e).on("PreProcess", function (e) {
      var t = r.dom,
        n = f(r);
      _.each(t.select("div", e.node), function (e) {
        t.hasClass(e, "mceTmpl") && (_.each(t.select("*", e), function (e) {
          t.hasClass(e, i(r).replace(/\s+/g, "|")) && (e.innerHTML = p(r, n))
        }), g(r, e))
      })
    })
  })
