...
! function () {
  ...
  var e = tinymce.util.Tools.resolve("tinymce.PluginManager"),
    ...
    m = function () {
      return '<img src="' + a.transparentSrc + '" class="' + g() + '" data-mce-resize="false" data-mce-placeholder />'
    };
  e.add("pagebreak", function (e) {
    ...
    (a = e).addCommand("mcePageBreak", function () {
    ...
    }), c = (o = e).getParam("pagebreak_separator", "\x3c!-- pagebreak --\x3e"), t = new RegExp(c.replace(/[\?\.\*\[\]\(\)\{\}\+\^\$\:]/g, function (e) {
      return "\\" + e
    }), "gi"), o.on("BeforeSetContent", function (e) {
      ...
      "IMG" === e.target.nodeName && r.dom.hasClass(e.target, g()) && (e.name = "pagebreak")
    })
  })
}();
