...
! function () {
  "use strict";
  var e, n, t = tinymce.util.Tools.resolve("tinymce.PluginManager"),
    ...
    v = function (n) {
      var t, o = l(n),
        ...
        i = n.$(r);
      return i.length && /^h[1-9]$/i.test(e) && (i = i.filter(function (t, e) {
    ...
    u = function (t) {
      ...
      if (!u.length) return "";
      for (a += (i = m(t), c = f.translate("Table of Contents"), l = "</" + i + ">", "<" + i + ' contenteditable="true">' + s.DOM.encode(c) + l), e = 0; e < u.length; e++) {
        if ((o = u[e]).element.id = o.id, r = u[e + 1] && u[e + 1].level, d === o.level) a += "<li>";
        else
          for (n = d; n < o.level; n++) a += "<ul><li>";
        if (a += '<a href="#' + o.id + '">' + o.title + "</a>", r !== o.level && r)
    ...
    i = function (t) {
      var e, n, o, r, i = l(t),
        c = t.$("." + i);
      o = t, !(r = c).length || 0 < o.dom.getParents(r[0], ".mce-offscreen-selection").length ? t.insertContent((n = u(e = t), '<div class="' + e.dom.encode(l(e)) + '" contenteditable="false">' + n + "</div>")) : d(t)
    },
    d = function (t) {
      var e = l(t),
        n = t.$("." + e);
    ...
    o = function (n) {
      return function (t) {
        ...
        return e(), n.on("LoadContent SetContent change", e),
          function () {
  ...
  t.add("toc", function (t) {
    ...
    (e = t).addCommand("mceInsertToc", function () {
      ...
      d(e)
    }), g(t), o = (n = t).$, r = l(n), n.on("PreProcess", function (t) {
      var e = o("." + r, t.node);
