...
! function () {
  ...
  var Re, Te, De, Oe, Be, Pe, Le, Ie = function (e, t) {
    ...
    lt = function (e, t) {
      var n, r, o, i, a, u, s, c, l, f, d, m, p = Ze.browsers(),
        g = Ze.oses(),
  ...
  Oe = undefined, Be = cr, Pe = lr, Le = undefined,
    function (e) {
  ...
  var Jr, Qr, Zr = function (t) {
    ...
    $o = (Jr = "data-mce-bogus", Qr = "all", function (e) {
    ...
    Ci = function (i) {
      var e, s, t, n, r, o, a, c, u, l, S = {},
        ...
        g = (e = (i = i || {}).schema, c = {}, u = function (e, t, n) {
          ...
          for (var n, r, o, i = yi(e), a = i.length, u = yi(t); a--;)
    ...
    Ti = (Di.prototype.bind = function (e, t, n, r) {
      ...
      if (e && 3 !== e.nodeType && 8 !== e.nodeType) {
        ...
        for (var m = t.split(" "), p = m.length; p--;) s = d, u = c = !1, "DOMContentLoaded" === (a = m[p]) && (a = "ready"), l.domLoaded && "ready" === a && "complete" === e.readyState ? n.call(r, Ri({
          type: a
  ...
  function ja(m, p, g, h, v, e) {
    return h && !h[Yi] && (h = ja(h)), v && !v[Yi] && (v = ja(v, e)), Oa(function (e, t, n, r) {
      var o, i, a, u = [],
        ...
        d = g ? v || (e ? m : c || h) ? [] : t : f;
      if (g && g(f, d, n, r), h)
        for (o = za(d, s), h(o, [], n, r), i = o.length; i--;)(a = o[i]) && (d[s[i]] = !(f[s[i]] = a));
      if (e) {
        if (v || m) {
          if (v) {
  ...
  Oi = Ta.support = {}, Li = Ta.isXML = function (e) {
    ...
    var t, s = e ? e.ownerDocument || e : Gi,
      n = s.defaultView;
        ...
        return 1 === p && 0 === g ? function (e) {
          ...
          if (l) {
            ...
            if (s = [v ? l.firstChild : l.lastChild], v && d) {
              ...
              for (;
                (i = ++u && i && i[c] || (a = u = 0) || s.pop()) && ((y ? i.nodeName.toLowerCase() !== f : 1 !== i.nodeType) || !++a || (d && ((i[Yi] || (i[Yi] = {}))[m] = [Ji, a]), i !== e)););
    ...
    pseudos: {
      ...
      contains: Oa(function (t) {
        return t = t.replace(Aa, Ra),
          function (e) {
            return -1 < (e.textContent || e.innerText || Pi(e)).indexOf(t)
          }
      }),
      lang: Oa(function (n) {
        return Ca.test(n || "") || Ta.error("unsupported lang: " + n), n = n.replace(Aa, Ra).toLowerCase(),
          function (e) {
            var t;
            do {
          ...
          if (t = Bi.relative[e[u].type]) l = [Fa(Ua(l), t)];
            ...
            if ((t = Bi.filter[e[u].type].apply(null, e[u].matches))[Yi]) {
              ...
              return ja(1 < u && Ua(l), 1 < u && Ma(e.slice(0, u - 1).concat({
                value: " " === e[u - 2].type ? "*" : ""
              })).replace(ga, "$1"), t, u < n && f(e.slice(u, n)), n < r && f(e = e.slice(n)), n < r && Ma(e))
            }
            l.push(t)
          } return Ua(l)
  ...
  var Ha = document,
    ...
    Ga = function (e, t) {
      var n, r = (t = t || Ha).createElement("div"),
    ...
    Ja = function (e, t, n, r) {
      ...
      if (Ya(t)) t = Ga(t, fu(e[0]));
        ...
        if (t = gu.makeArray(t), r)
          for (o = t.length - 1; 0 <= o; o--) Ja(e, t[o], n, r);
        else
          for (o = 0; o < t.length; o++) Ja(e, t[o], n, r);
        return e
      }
      if (t.nodeType)
  ...
  au.fn = au.prototype = {
    ...
    init: function (e, t) {
      ...
      if (Ya(e)) {
        ...
        if (n[1])
          for (r = Ga(e, fu(t)).firstChild; r;) Va.call(o, r), r = r.nextSibling;
        else {
    ...
    add: function (e, t) {
      ...
      if (!1 !== t)
        for (n = gu.unique(this.toArray().concat(gu.makeArray(e))), this.length = n.length, r = 0; r < n.length; r++) this[r] = n[r];
  ...
  var Su = xu.DOM,
    Nu = _t.each,
    Eu = _t.grep,
    ku = (_u.prototype._setReferrerPolicy = function (e) {
  ...
  var Ms, Fs, Us = function (e, t) {
    ...
    Xs = function (e, t) {
      ...
      return js(a) ? n = function (e, t) {
        for (;
          (e = e.previousSibling) && js(e);) t += e.data.length;
        return t
    ...
    oc = function (e, t) {
      ...
      return zs(n, r, l), e.moveToBookmark({
        id: o,
        keep: !0
      }), {
        id: o
      ...
      return {
        show: function (t, e) {
          ...
          if (!a(e)) return u = function (e, t) {
            var n, r = e.ownerDocument.createTextNode(mo),
              o = e.parentNode;
            if (t) {
    ...
    Gc = function (e, t, n, r, o) {
      ...
      if (t < 0) {
        ...
        for (; e = Yc(i.prev.bind(i), o);)
          if (n(e)) return e
      }
      if (0 < t) {
        if (a && n(e = Yc(i.next.bind(i), !0))) return e;
        for (; e = Yc(i.next.bind(i), o);)
          if (n(e)) return e
      }
      return null
    },
  ...
  var ll, fl, dl, ml, pl = qn,
    ...
    Ef = function (t, e, n, r) {
      ...
      if (e[0].wrapper || (i = a.getParent(n, e[0].block, u)), i || (o = a.getParent(n, "LI,TD,TH"), i = a.getParent(Mn(n) ? n.parentNode : n, function (e) {
          return e !== u && yf(t, e)
        }, o)), i && e[0].wrapper && (i = hf(a, i, "ul,ol").reverse()[0] || i), !i)
    ...
    Xf = function (u, s, c, l) {
      u.undoManager.transact(function () {
        var e, t, n, r, o = u.selection,
          i = o.getRng(),
          a = 0 < Lf(u).length;
        i.collapsed && !a && (n = Rf(e = u, t = i, [{
          inline: !0
        }]), t.setStart(n.startContainer, n.startOffset), t.setEnd(n.endContainer, n.endOffset), e.selection.setRng(t)), o.getRng().collapsed && !a ? (r = Wf(u.getDoc(), l, s, c.decorate), es(r, fo), o.getRng().insertNode(r.dom), o.select(r.dom)) : Hf(o, !1, function () {
          jf(u, function (e) {
    ...
    Yf = function (u) {
      ...
      return {
        ...
        getAll: function (e) {
          var t, n, r, o, i, a = (t = u, n = e, r = Rt.fromDom(t.getBody()), o = qu(r, "[" + Wu() + '="' + n + '"]'), i = {}, Y(o, function (e) {
            var t = Jn(e, Ku()),
  ...
  var Jf = function (e, t) {
    ...
    td = qn,
    nd = function (r, l) {
      var f, d, m, p, c, g, h, v, y, b, C, w, x, S, N, E = "data-mce-selected",
        k = l.dom,
        _ = _t.each,
        A = l.getDoc(),
        R = document,
        ...
        U = function (e) {
          var t, n, r, o, i, a, u, s = e.screenX - g,
            c = e.screenY - h;
    ...
    sd = function (e, t, n) {
      for (var r = new Yr(t, e.getParent(t.parentNode, e.isBlock) || e.getRoot()); t = r[n ? "prev" : "next"]();)
        if (jn(t)) return !0
    },
  ...
  var gd, hd, vd, yd, bd, Cd = (gd = "height", hd = function (e) {
    ...
    Sd = function (e) {
      var t, n, r, o = Rt.fromDom(document),
        i = xn(o),
    ...
    kd = function (e, t) {
      var n = function (e, t) {
          var n = Jt(e);
          if (0 === n.length || Nd(e)) return {
            element: e,
            offset: t
          };
          if (t < n.length && !Nd(n[t])) return {
            element: n[t],
            offset: 0
          };
          var r = n[n.length - 1];
    ...
    lm = function (n, e) {
      ...
      um(t), t.on("focusin", function () {
        ...
        t && function (e) {
          ...
          e.ownerDocument === document && (e === document.body || cm(t, e) || n.focusedEditor !== t || (t.fire("blur", {
            focusedEditor: null
          }), n.focusedEditor = null))
        })
  ...
  var Lm, Im, Mm = function (e, t) {
    ...
    eg = function (t, n, e, r) {
      void 0 === r && (r = !0);
      var o, i, a = Yp(n, t.getBody(), e.dom),
        u = Tr(e, N(Jp, t), (o = t.getBody(), function (e) {
          return e.dom === o
        })),
    ...
    _g = function (e, t) {
      var n, r, o, i, a, u = Rt.fromDom(e.selection.getStart(!0)),
        s = Lf(e);
    ...
    Mg = function (e, o, i, t) {
      var n, r, a, u, s, c, l, f, d, m, p, g, h, v, y, b, C, w, x, S, N = (n = o, r = t, c = e.serialize(r), l = n.createFragment(c), u = (a = l).firstChild, s = a.lastChild, u && "META" === u.nodeName && u.parentNode.removeChild(u), s && "mce_marker" === s.id && s.parentNode.removeChild(s), a),
        ...
        k = Bg((f = N.firstChild, _t.grep(f.childNodes, function (e) {
    ...
    $g = function (u, s, c) {
      return c.format = c.format ? c.format : "html", c.set = !0, c.content = Vg(s) ? "" : s, c.no_events || u.fire("BeforeSetContent", c), Vg(s) || (s = c.content), U.from(u.getBody()).fold(S(s), function (e) {
        ...
        }(u, e, s, c) : (t = u, n = e, o = c, 0 === (r = s).length || /^\s+$/.test(r) ? (a = '<br data-mce-bogus="1">', "TABLE" === n.nodeName ? r = "<tr><td>" + a + "</td></tr>" : /^(UL|OL)$/.test(n.nodeName) && (r = "<li>" + a + "</li>"), r = (i = lc(t)) && t.schema.isValidChild(n.nodeName.toLowerCase(), i.toLowerCase()) ? (r = a, t.dom.createHTML(i, fc(t), r)) : r || '<br data-mce-bogus="1">', qg(t, r), t.fire("SetContent", o)) : ("raw" !== o.format && (r = qm({
          validate: t.validate
      ...
      if (c)
        if ("undefined" == typeof c.length) {
          ...
          for (s = 0; s < c.length; s++)
            if ("attributes" === r ? e.getAttrib(t, c[s]) : sf(e, t, c[s])) return n;
      return n
    },
    ...
    lh = function (e, t, n) {
      ...
      var r = e.dom,
        o = e.selection;
      if (t) ch(e, t, n);
      else if (!(t = Ul(e.getBody(), o.getStart())))
        for (; t = r.get(ih);) ch(e, t, !1)
    },
    fh = function (e, t) {
    ...
    mh = function (e, t, n, r) {
      var o, i, a, u, s, c, l, f, d, m, p, g, h, v = e.dom,
        y = e.selection,
        b = [],
        C = y.getRng(),
        w = C.startContainer,
  ...
  var bh = _t.each,
    ...
    zh = function (s, c, l, e, f) {
      var t, d = s.formatter.get(c),
        ...
        n = s.selection,
        u = function (e) {
          var n, t, r, o, i, a, u = (t = e, r = c, o = l, i = f, Y(lf((n = s).dom, t.parentNode).reverse(), function (e) {
            var t;
        ...
        p = function (e) {
          ...
          if (i && !n)
            for (var o = 0; o < d.length && !Fh(s, d[o], l, e, e); o++);
          if (m.deep && r.length) {
      ...
      else if ("false" !== a.getContentEditable(n.getNode())) n.isCollapsed() && m.inline && !Lf(s).length ? mh(s, c, l, f) : (Hf(n, !0, function () {
        jf(s, r)
      }), m.inline && th(s, c, l, n.getStart()) && Zl(a, n, n.getRng()), s.nodeChanged());
      else {
        e = n.getNode();
    ...
    av = function (e, t) {
      var n, r = Rt.fromDom(t.commonAncestorContainer),
        o = fp(r, e),
        i = H(o, function (e) {
          return no(e) || eo(e)
        }),
        a = iv(o, t),
        u = i.concat(a.length ? a : ao(n = r) ? Wt(n).filter(io).fold(S([]), function (e) {
          return [n, e]
        }) : io(n) ? [n] : []);
      return z(u, ns)
    },
    ...
    pv = function (e, t, n) {
      ...
      n.getInner = !0;
      var r, o, i, a, u, s, c, l = (o = n, i = (r = e).selection.getRng(), a = r.dom.create("body"), u = r.selection.getSel(), s = Nm(r, Of(u)), (c = o.contextual ? lv(Rt.fromDom(r.getBody()), s).dom : i.cloneContents()) && a.appendChild(c), r.selection.serializer.serialize(a, o));
    ...
    wv = function (e, t, n) {
      "fragmented" === t.type ? yv(t.fragments, e.getBody()) : e.setContent(t.content, {
        format: "raw"
    ...
    Av = function (f) {
      return {
        undoManager: {
          ...
          undo: function (e, t, n) {
            return r = f, i = t, a = n, (o = e).typing && (o.add(), o.typing = !1, kv(o, !1, i)), 0 < a.get() && (a.set(a.get() - 1), u = o.data[a.get()], wv(r, u, !0), r.setDirty(!0), r.fire("Undo", {
              level: u
            })), u;
            var r, o, i, a, u
          },
          redo: function (e, t) {
            return n = f, o = t, (r = e).get() < o.length - 1 && (r.set(r.get() + 1), i = o[r.get()], wv(n, i, !1), n.setDirty(!0), n.fire("Redo", {
              level: i
            })), i;
            var n, r, o, i
          },
  ...
  var Fv, Uv, zv = function (e) {
    ...
    Gv = function (r, o, i, t) {
      ...
      0 !== o.src.indexOf("blob:") ? (n = (e = $v(o.src)).data, a = e.type, u = n, (s = r.getByData(u, a)) ? i({
        ...
        n = t, new Ir(function (e) {
          ...
          u = $v(e).data, s = r.create(Yv(), t, u), r.add(s), i({
            image: o,
            blobInfo: s
          })
        })
        ...
        n = {
          ...
          parse: function (e, u) {
            ...
            if (k.parse(e, u.format), g && l.length && (u.context ? u.invalid = !0 : function (e) {
                for (var t, n, r, o, i, a, u, s, c, l, f = ry("tr,td,th,tbody,thead,tfoot,table"), d = R.getNonEmptyElements(), m = R.getWhiteSpaceElements(), p = R.getTextBlockElements(), g = R.getSpecialElements(), h = 0; h < e.length; h++)
    ...
    vy = function (e) {
      ...
      e.removed || (t = e._selectionOverrides, n = e.editorUpload, r = e.getBody(), o = e.getElement(), r && e.save({
        is_removing: !0
      }), e.removed = !0, e.unbindAllNativeEvents(), e.hasHiddenInput && o && gy.remove(o.nextSibling), e.fire("remove"), e.editorManager.remove(e), !e.inline && r && (i = e, gy.setStyle(i.id, "display", i.orgDisplay)), e.fire("detach"), gy.remove(e.getContainer()), hy(t), hy(n), e.destroy())
    },
    yy = function (e, t) {
    ...
    Oy = function (e, t, n, r) {
      var o, i, a, u = _y(n.forced_plugins),
        s = _y(r.plugins),
    ...
    Wy = function (n) {
      var t, o = [],
        ...
        r = function (r, e) {
          if (void 0 === e && (e = !0), !n.removed && $y(n)) return e && n.fire("BeforeOpenNotification", {
            notification: r
          }), W(o, function (e) {
  ...
  var Yy, Gy, Jy = function (n) {
    ...
    bb = function (n, e) {
      ...
      var c, l = (c = e.selector) && "string" == typeof c ? (c = (c = c.split(/\s*,\s*/)[0]).replace(/\s*(~\+|~|\+|>)\s*/g, "$1"), _t.map(c.split(/(?:>|\s+(?![^\[\]]+\]))/), function (e) {
      ...
      var e, u = a.dom,
        ...
        l = function (e, t) {
          ...
          ! function (e) {
            ...
            return !1
          }(u, n, s), "" !== u.getAttrib(n, Nb) === r && !t || (u.setAttrib(n, Nb, r ? c : null), u.setAttrib(n, "aria-placeholder", r ? c : null), i = r, a.fire("PlaceholderToggle", {
            state: i
    ...
    hC = function (e) {
      ...
      return Vn(o) && n.isBlock(o) && n.isEmpty(o) && (t = n.create("br", {
        "data-mce-bogus": "1"
      }), n.setHTML(o, ""), o.appendChild(t), r.setRng(Is.before(t).toRange())), !0
    },
    vC = function (e, t) {
    ...
    uw = function (n, r, i, o) {
      var e, t, a = (e = n.getBody(), t = o.container(), Jc(t, e) || e),
        u = N(Rb, n),
        s = UC(u, a, o);
  ...
  var Vw = function (o, i, a, e, u, t) {
    ...
    nx = function (e, t, n) {
      var r, o, i = Hw(H(ie(e.getElementsByTagName("*")), jc)),
        a = H(i, N(Zw, n));
      if (u = ex(a, t)) {
        ...
        if ((u = ex(function (e, r, t) {
          ...
          }(e, u, s), t)) && jc(u.node)) return o = t, {
          node: (r = u).node,
          before: Gw(r, o) < Jw(r, o)
        }
      }
      return null
    },
    ...
    ax = function (t, e, n, r, o, i) {
      var a = al(e, t.getBody(), n),
        ...
        s = e === Tw.Down;
      if (!u) return U.none();
      var c, l = (s ? $w : qw)(t.getBody(), Ww(1), a),
        f = H(l, Kw(1)),
        d = u.left,
        m = ex(f, d);
      if (m && i(m.node)) {
    ...
    wx = function (t, n) {
      var e, r, o = Rt.fromDom(t.getBody()),
    ...
    aS = function (a, e) {
      ...
      }(f, s), f.isEmpty(s) && eS(s), n.normalize(), f.isEmpty(n) ? (f.remove(n), v()) : (iS(a, n), Kx(a, n))), f.setAttrib(n, "id", ""), a.fire("NewBlock", {
        newBlock: n
      })))
    },
    uS = function (e, t, n) {
    ...
    sS = function (e, t) {
      ...
      "LI" !== d || m || (l = f), c && 3 === c.nodeType && s >= c.nodeValue.length && ! function (e, t, n) {
        for (var r, o = new Yr(t, n), i = e.getNonEmptyElements(); r = o.next();)
    ...
    gS = function (e, t) {
      var n, r, o, i = (r = N(Rb, n = e), o = Is.fromRangeStart(n.selection.getRng()), UC(r, n.getBody(), o).filter(mS));
    ...
    FS = function (e) {
      var t, n, r = Is.fromRangeStart(e.selection.getRng()),
  ...
  function HS(r) {
    ...
    "onselectionchange" in r.getDoc() || r.on("NodeChange click mouseup keyup focus", function (e) {
      ...
      !e || !xt.range && r.selection.isCollapsed() || zf(r) && !t.isSameElementPath(e) && r.dom.isChildOf(e, r.getBody()) && r.nodeChanged({
        selectionChange: !0
      })
  ...
  var VS = function (e) {
      ...
      return h.on("remove", v.stop),
        function (g) {
          return e.on(function (e) {
            var t, n, r, o, i, a, u, s, c, l, f, d, m, p = Math.max(Math.abs(g.screenX - e.screenX), Math.abs(g.screenY - e.screenY));
            if (!e.dragging && 10 < p) {
              if (h.fire("dragstart", {
                  target: e.element
    ...
    aN = function (u) {
      var s, c = u.selection,
        ...
        C = function (e) {
          ...
          var r = function (e, t, n) {
              var r = u.$,
                o = Pr(Rt.fromDom(u.getBody()), "#" + p).fold(function () {
                  return r([])
                }, function (e) {
                  return r([e.dom])
                });
              ...
              var i = l.createRng();
              t === n && xt.ie ? (o.empty().append('<p style="font-size: 0" data-mce-bogus="all">\xa0</p>').append(t), i.setStartAfter(o[0].firstChild.firstChild), i.setEndAfter(t)) : (o.empty().append(fo).append(t).append(fo), i.setStart(o[0].firstChild, 1), i.setEnd(o[0].lastChild, 0)), o.css({
      ...
      return xt.ceFalse && function () {
        ...
        var a = function (e) {
            ...
            var n, r = Is.before(e.firstChild),
              o = t.next(r);
    ...
    dN = function (e) {
      var t;
      e.bindPendingEventDelegates(), e.initialized = !0, e.fire("Init"), e.focus(!0), fN(e), e.nodeChanged({
        initial: !0
      }), e.execCallback("init_instance_callback", e), (t = e).settings.auto_focus && Wr.setEditorTimeout(t, function () {
    ...
    WN = _t.map,
    KN = _t.inArray,
    XN = (YN.prototype.execCommand = function (t, n, r, e) {
      var o, i, a = !1,
        u = this;
      if (!u.editor.removed) {
  ...
  var uE, sE = function (n) {
    ...
    hE = function (e, t, n, r) {
      ...
      i.deactivate(), i.editorReadOnly !== a.editorReadOnly && eE(e, a.editorReadOnly), t.set(r), o = r, e.fire("SwitchMode", {
        mode: o
      })
    },
    vE = function (t) {
  ...
  var OE = xu.DOM,
    ...
    ME = (FE.prototype.render = function () {
      ...
      e === undefined ? py(this, this.startContent, {
        format: "raw"
      }) : py(this, e), this.undoManager.reset(), this.setDirty(!1), this.nodeChanged()
  ...
  function FE(e, t, n) {
    ...
    this.mode = o, this.setMode = o.set, n.fire("SetupEditor", {
      editor: this
    }), this.execCallback("setup", this), this.$ = gu.overrideDefaults(function () {
      return {
  ...
  var UE, zE = xu.DOM,
    ...
    QE = _e(_e({}, cE), {
      ...
      add: function (e) {
        var n = this;
        return WE[e.id] === e || (null === n.get(e.id) && ("length" !== e.id && (WE[e.id] = e), WE.push(e), KE.push(e)), YE(!0), n.activeEditor = e, n.fire("AddEditor", {
          editor: e
        }), UE || (UE = function (e) {
      ...
      remove: function (e) {
        var t, n, r = this;
        if (e) {
          if (!K(e)) return n = e, A(r.get(n.id)) ? null : (GE(n) && r.fire("RemoveEditor", {
            editor: n
          }), 0 === KE.length && window.removeEventListener("beforeunload", UE), n.remove(), YE(0 < KE.length), n);
          HE(zE.select(e), function (e) {
            (n = r.get(e.id)) && r.remove(n)
          })
        } else
          for (t = KE.length - 1; 0 <= t; t--) r.remove(KE[t])
      },
    ...
    sk = {
      ...
      findBestRelativePosition: function (e, t, n, r) {
        for (var o, i = 0; i < r.length; i++)
          if ((o = ak(e, t, r[i])).x >= n.x && o.x + o.w <= n.w + n.x && o.y >= n.y && o.y + o.h <= n.h + n.y) return r[i];
        return null
      },
  ...
  dk.extend = tk = function (n) {
    var o = this.prototype,
      r = function () {
        var e, t, n;
        if (!nk && (this.init && this.init.apply(this, arguments), t = this.Mixins))
  ...
  var mk = Math.min,
    ...
    yk = _e(_e({}, cE), {
      send: function (e) {
        ...
        if (e.scope = e.scope || this, e.success_scope = e.success_scope || e.scope, e.error_scope = e.error_scope || e.scope, e.async = !1 !== e.async, e.data = e.data || "", yk.fire("beforeInitialize", {
            settings: e
          }), (t = new XMLHttpRequest).overrideMimeType && t.overrideMimeType(e.content_type), t.open(e.type || (e.data ? "POST" : "GET"), e.url, e.async), e.crossDomain && (t.withCredentials = !0), e.content_type && t.setRequestHeader("Content-Type", e.content_type), e.requestheaders && _t.each(e.requestheaders, function (e) {
  ...
  var Nk, Ek = {
    ...
    kk = _t.extend(QE, Ek);
  Nk = kk, window.tinymce = Nk, window.tinyMCE = Nk,
    function (e) {
